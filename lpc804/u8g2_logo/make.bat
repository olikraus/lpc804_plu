...
set CCFLAGS=-mthumb -mcpu=cortex-m0plus -Wall -I. -I..\..\..\u8g2\csrc -I..\lpc_chip_804 -I..\common  -Os  -ffunction-sections -fdata-sections -std=gnu99
...
rem ..\..\tools\pluc\pluc ws2812b.bex ws2812b.kiss -oc plu_setup.c -fn plu -clkdiv 6 -xrst

set SRC=
for %%f in (..\..\..\u8g2\csrc\*.c) do call set SRC=%%SRC%% %%f
